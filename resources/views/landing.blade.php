    ...
    <div class="h-screen bg-right bg-cover" style="background-image:url('img/map7.svg');">
        ...
        <div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                <h1
                    class="my-4 text-3xl md:text-5xl text-teal-700 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">
                    Jual Beli dan Sewa Tanah</h1>
                <p class="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle text-gray-500">
                    Selamat datang diaplikasi JBT desa Nawangsari, Silahkan login untuk dapat melakukan transaksi dengan nyaman dan aman</p>

                <p class="text-teal-500 font-bold pb-8 lg:pb-6 text-center md:text-left fade-in">Sudah Punya Akun ?</p>
                <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in text-white">
                    ...
                    <a class="h-12  bounce-top-icons rounded btn bg-teal-600 shadow mr-2 px-3 py-3 hover:bg-teal-500" href='{{ route('login')}}'>
                        Masuk</a>
                    <a class="h-12  bounce-top-icons rounded btn bg-teal-600 shadow mr-2 px-3 py-3 hover:bg-teal-500" href='{{ route('register')}}'>
                            Daftar</a>
                </div>
